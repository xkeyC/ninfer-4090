...
void TextContext::mtp_forward_tail(Tensor& x, const Tensor& ah, const Tensor& positions,
    ...
    ops::rope(rope_for_op, kCfg.rotary_dim, kCfg.rope_theta, qn, kn, s, rope_scaling_);
...
void TextContext::mtp_prefill_chunk(const Tensor& ids, const Tensor& hidden,
...

    {
        ...
        ops::rmsnorm(k, *mtp_.k_norm, kCfg.rms_eps, true, kn, s);
        ops::rope(rope_positions, kCfg.rotary_dim, kCfg.rope_theta, kn, s, rope_scaling_);
    ...
    if (final_chunk) {
        ...
        ops::rope(last_rope_position, kCfg.rotary_dim, kCfg.rope_theta, qn, s, rope_scaling_);
